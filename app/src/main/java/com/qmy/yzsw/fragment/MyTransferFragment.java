...
public class MyTransferFragment extends BaseFragment {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        mAdapter = new MyLeaseaAapter(getActivity(), "2");
    ...
    public void onResume() {
        super.onResume();
        HttpUtils.leaselist(getActivity(), 2, myself, new JsonCallback<BaseBean<List<LeaseBean>>>() {
            @Override
    ...
    public MyTransferFragment newInstance(int myself) {
        MyTransferFragment f = new MyTransferFragment();
        Bundle b = new Bundle();
